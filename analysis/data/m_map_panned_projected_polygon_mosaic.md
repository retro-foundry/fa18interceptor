...
49-polygon, run038 58-polygon, bounded moving run041 50-polygon, run024
42-polygon, and run003 42-polygon M-map
...
`(0,0)`, run037 is translated by `(14,45)`, run035 by `(130,61)`, run038 by
`(154,71)`, run041 by `(172,72)`, run024 by `(270,96)`, and run003 by
`(272,97)` host pixels. The run024/run035 join has 98.1594% blue-water
