...
run033's Golden Gate state 49-polygon, run001 36-polygon, run024 42-polygon,
run003 42-polygon, and bounded run004 22-polygon M-map passes. Every blue
shape is a direct `$C4B390`
...
Alcatraz-window state by `(172,67)`, run033 frame 5,250 by `(210,79)`, run001 by `(194,121)`,
