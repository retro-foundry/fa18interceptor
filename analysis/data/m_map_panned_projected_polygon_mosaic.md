...
50-polygon, run024 42-polygon, and run003 42-polygon M-map
...
`(130,61)`, run038 by `(154,71)`, run041 by `(172,72)`, run024 by `(270,96)`,
and run003 by `(272,97)` host pixels. The run002/run035 join has 97.9792%
