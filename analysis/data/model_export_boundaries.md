...
| --- | --- | --- | --- |
| `$C3515E-$C351DC` / `$C34C06-$C34C48` | 22 local triples plus five Hunk-41 face records | `$C1F100/$C1F21C` -> `$C46228-$C462A6`; `$C0D384-$C0D521` derives slots 22-35; `$C203C4` -> `$C2469E` | **partial source-to-face model**; all 36 renderer slots have a traced runtime producer, but only 22 are static source triples |
