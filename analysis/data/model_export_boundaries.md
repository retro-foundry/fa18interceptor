...
| `$C363EC/$C3628A` | four static triples plus `$C366D4` two-segment line record | `$C1F4AC` -> `$C48390` slots 0--3 -> `$C212B0` | exportable unnamed close-range line component; [trace and payload](c363ec_c3628a_close_range_line_component.md) retain its data/code boundary without assigning an LOD role |
