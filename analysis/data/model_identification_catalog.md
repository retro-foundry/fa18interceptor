...
| `$C39D2A` to `$C3925C/$C3925E` | 43 static triples and 10 unique pre-cull faces / 45 polygon edges; source transform and both face contexts traced | **user-identified aircraft-carrier deck/island** candidate | [static topology candidate](../plots/c39d2a_c3925_static_topology_candidate.svg) |
