...
Authority: `build/run033_origin_group_0c_trace/trace.jsonl` and its frame-0 slow-RAM snapshot.  `$C1D488` supplies each static header; `$C1D4BC` copies its following two words; `$C1DD36` is the later cell-header reader.

The bounded trace has **10** observed static-entry copies.  **4** are later read at `$C1DD36` before the trace ends.  An absent later read means only that this bounded trace did not reach one; it is not rejection evidence.
...
| ---: | --- | ---: | --- | --- | --- | --- |
| stepped | $C42951 | 66 | $52 -> $0052 | $0800 $0300 | $C49290 | not reached before trace end |
| stepped | $C42957 | 66 | $15 -> $0015 | $0400 $0E00 | $C49296 | not reached before trace end |
