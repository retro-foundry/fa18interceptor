...
Authority: `build/run033_origin_row_08_trace/trace.jsonl` and its frame-0 slow-RAM snapshot.  `$C1D488` supplies each static header; `$C1D4BC` copies its following two words; `$C1DD36` is the later cell-header reader.

The bounded trace has **13** observed static-entry copies.  **7** are later read at `$C1DD36` before the trace ends.  An absent later read means only that this bounded trace did not reach one; it is not rejection evidence.
...
| ---: | --- | ---: | --- | --- | --- | --- |
| stepped | $C42951 | 66 | $52 -> $0052 | $0800 $0300 | $C49890 | not reached before trace end |
| stepped | $C42957 | 66 | $15 -> $0015 | $0400 $0E00 | $C49896 | not reached before trace end |
| stepped | $C4295D | 66 | $2D -> $002D | $0800 $0800 | $C49590 | not reached before trace end |
| stepped | $C42963 | 66 | $4A -> $004A | $0800 $0800 | $C49AD0 | not reached before trace end |
| stepped | $C42957 | 66 | $15 -> $0015 | $0400 $0E00 | $C4B690 | $C4E9C2 / $C2232C / (672, 0, -144) |
| stepped | $C4295D | 66 | $2D -> $002D | $0800 $0800 | $C4B390 | $C4E9AA / $C2250C / (704, 0, 64) |
| stepped | $C42963 | 66 | $4A -> $004A | $0800 $0800 | $C4B8D0 | $C4E9DA / $C22750 / (448, 0, -320) |
