...
| run026 | raw recording | 301 | 7,030 | absent (five startup records) | active cockpit | no |
| run027 | raw recording | 389 | 27,047 | absent (five startup records) | active cockpit | no |
| run028 | raw recording | 377 | 10,526 | absent (five startup records) | active/near-blank cockpit | no |
| run029 | sealed | 266 | 14,298 | absent in existing bounded monitors | active cockpit | no |
...
not prove that success can never be drawn through another route. The final
screens and absence of a captured success record mean these four recordings
cannot be used as the successful-qualification oracle. No run later than
run029 contains a recorded key-5 qualification selection.
