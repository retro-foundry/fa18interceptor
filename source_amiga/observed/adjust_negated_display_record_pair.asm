; Byte-exact $C2EAD0-$C2EB4B arithmetic helper called by $C2E758.
; This is the observed negated-input variant of the $C2EA5A helper.
                org $C2EAD0
adjust_negated_display_record_pair:
 movem.l d0-d6,-(sp)
