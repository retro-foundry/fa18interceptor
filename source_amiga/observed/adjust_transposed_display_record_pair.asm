; Byte-exact $C2EB4C-$C2EBBF arithmetic helper called by $C2E758.
; It is a transposed register variant of the neighbouring adjustment helpers.
                org $C2EB4C
adjust_transposed_display_record_pair:
 movem.l d0-d6,-(sp)
