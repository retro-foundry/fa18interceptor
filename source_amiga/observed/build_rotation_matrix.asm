; Byte-exact reconstruction of $C2E47A-$C2E513 (Hunk 32 +$5E).
; Input:  D0.w, D2.w, D4.w are native angle words; A1 points to 9 words.
; Output: nine signed fixed-point rotation-matrix words at A1..A1+$10.
